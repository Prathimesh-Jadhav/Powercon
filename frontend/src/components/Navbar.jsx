...
const Navbar = () => {
  ...
  return (
    <div className={`w-full h-16 flex items-center justify-between md:px-10 max-md:px-4 py-4 text-roboto fixed top-0 right-0 left-0 gap-4 nav z-30 ${blur ? 'bg-black/70 backdrop-blur-md' : 'bg-transparent'} transition-all duration-300 ease-in-out`}>
